...
pcall(function()
	...
	task.spawn(function()
		while task.wait() do
			for v223, v224 in pairs(game.Workspace['_WorldOrigin']:GetChildren()) do
				if ((v224.Name == "Dust") or (v224.Name == "eff") or (v224.Name == "CurvedRing") or (v224.Name == "SwordSlash") or (v224.Name == "Sounds") or (v224.Name == "SlashHit")) then
					v224:Destroy();
				end
			end
		end
	...
	task.spawn(function()
		while wait() do
			pcall(function()
				for v269, v270 in pairs(game:GetService("Workspace").Enemies:GetDescendants()) do
					if (v270.ClassName == "MeshPart") then
						v270.Transparency = 0.5;
					end
				end
				for v271, v272 in pairs(game:GetService("Workspace").Enemies:GetDescendants()) do
					if (v272.Name == "Head") then
						v272.Transparency = 0.5;
					end
				end
				for v273, v274 in pairs(game:GetService("Workspace").Enemies:GetDescendants()) do
					if (v274.ClassName == "Accessory") then
						v274.Handle.Transparency = 0.5;
					end
				end
				for v275, v276 in pairs(game:GetService("Workspace").Enemies:GetDescendants()) do
					if (v276.ClassName == "Decal") then
						v276.Transparency = 0.5;
					end
				end
			end);
		end
	...
	local v27 = v0:Load({Name=("Manake Hub Premium script | " .. os.date("%A, %B %d %Y")),SizeX=750,SizeY=800,Theme="Midnight",Extension="json",Folder="Manake Hub Premium script"});
	...
	local v37 = v29:Section({Name="Server jobId",Side="Right"});
									...
									if ((v460.Name == Name) and v460:FindFirstChild("HumanoidRootPart") and v460:FindFirstChild("Humanoid")) then
										if (v460.Humanoid.Health > 0) then
											repeat
												...
												Equip(WeaponName);
												AutoHaki();
												v50(v460.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
	...
	if Old_World then
		local v209 = v41:Toggle({Name="AutoFarmSky",Flag="AutoFarmLevel",Default=getgenv().AutoOpen.AutoFarmLeve,Callback=function(v208)
			AutoFarmSky = t;
			FastAttackSpeed = t;
		end});
	end
									...
									for v486, v487 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
										if ((v487.Name == "Ice Admiral [Lv. 700] [Boss]") and (v487.Humanoid.Health > 0)) then
											repeat
												...
												AutoHaki();
												Equip(WeaponName);
												v50(v487.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
											...
											for v522, v523 in pairs(game.Workspace.Enemies:GetChildren()) do
												if ((v523.Name == "rip_indra [Lv. 1500] [Boss]") and v523:FindFirstChild("Humanoid") and v523:FindFirstChild("HumanoidRootPart") and (v523.Humanoid.Health > 0)) then
													repeat
														...
														v50(v523.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
											...
											if ((v550.Name == "Don Swan [Lv. 1000] [Boss]") and v550:FindFirstChild("Humanoid") and v550:FindFirstChild("HumanoidRootPart") and (v550.Humanoid.Health > 0)) then
												repeat
													...
													elseif ((v550.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300) then
														...
														v50(v550.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
													end
												...
												pcall(function()
													repeat
														...
														elseif ((v525.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300) then
															...
															v50(v525.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
														end
										...
										if (v527.Name == "Jeremy [Lv. 850] [Boss]") then
											repeat
												...
												elseif ((v527.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300) then
													...
													v50(v527.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
												end
								...
								if ((v403.Name == "Candy Pirate [Lv. 2400]") or (v403.Name == "Snow Demon [Lv. 2425]")) then
									if (v403:FindFirstChild("Humanoid") and v403:FindFirstChild("HumanoidRootPart") and (v403.Humanoid.Health > 0)) then
										repeat
											...
											v50(v403.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
									...
									if ((v440.Name == "Reborn Skeleton [Lv. 1975]") or (v440.Name == "Living Zombie [Lv. 2000]") or (v440.Name == "Demonic Soul [Lv. 2025]") or (v440.Name == "Posessed Mummy [Lv. 2050]")) then
										if (v440:FindFirstChild("Humanoid") and v440:FindFirstChild("HumanoidRootPart") and (v440.Humanoid.Health > 0)) then
											repeat
												...
												v50(v440.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
									...
									if ((v442.Name == "Fishman Raider [Lv. 1775]") or (v442.Name == "Fishman Captain [Lv. 1800]")) then
										if (v442:FindFirstChild("Humanoid") and v442:FindFirstChild("HumanoidRootPart") and (v442.Humanoid.Health > 0)) then
											repeat
												...
												v50(v442.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
									...
									if ((v444.Name == "Dragon Crew Warrior [Lv. 1575]") or (v444.Name == "Dragon Crew Archer [Lv. 1600]")) then
										if (v444:FindFirstChild("Humanoid") and v444:FindFirstChild("HumanoidRootPart") and (v444.Humanoid.Health > 0)) then
											repeat
												...
												v50(v444.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
								...
								if (AutoCakePrince and (v415.Name == "Cake Prince [Lv. 2300] [Raid Boss]") and v415:FindFirstChild("HumanoidRootPart") and v415:FindFirstChild("Humanoid") and (v415.Humanoid.Health > 0)) then
									repeat
										...
										elseif ((v415.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300) then
											...
											v50(v415.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
										end
							...
							if (((v417.Name == "Cookie Crafter [Lv. 2200]") or (v417.Name == "Cake Guard [Lv. 2225]") or (v417.Name == "Baking Staff [Lv. 2250]") or (v417.Name == "Head Baker [Lv. 2275]")) and v417:FindFirstChild("HumanoidRootPart") and v417:FindFirstChild("Humanoid") and (v417.Humanoid.Health > 0)) then
								repeat
									...
									elseif ((v417.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300) then
										...
										v50(v417.HumanoidRootPart.CFrame * CFrame.new(0, 10, 0));
									end
	...
	local v65 = v38:Toggle({Name="Auto Attach",Flag="Auto_Attach",Default=false,Callback=function(v52)
		_G.AutoClick = v52;
	end});
	...
	local v65 = v38:Toggle({Name="Bringmob",Flag="Bringmob",Default=true,Callback=function(v52)
		_G.Bringmob = v52;
		Bringmob = v52;
	end});
	...
	if Old_World then
		TISLAND = {"Forgotten IsLand","Ice Castle","Cursed Ship","Awakeing Room","Hot Land","Cold Land","Snow Moutain","Gravetard Island","Gravetard Island Mon","Factory","Cafe","Swan Room","Dark Arena"};
		DefaultDrop = "Cafe";
	elseif New_World then
		TISLAND = {"Forgotten IsLand","Ice Castle","Cursed Ship","Awakeing Room","Hot Land","Cold Land","Snow Moutain","Gravetard Island","Gravetard Island Mon","Factory","Cafe","Swan Room","Dark Arena"};
		DefaultDrop = "Cafe";
	elseif Three_World then
		TISLAND = {"Port Town","Hydra Island","Green Tree","Castle on the sea","Mansion","Haunted Castle","Sea of Treats"};
		DefaultDrop = "Castle on the sea";
	end
	_G.Teleport = false;
	Locations = {};
	local v79 = {};
	for v173, v174 in pairs(game:GetService("Workspace")['_WorldOrigin'].Locations:GetChildren()) do
		table.insert(Locations, v174.Name);
		task.spawn(function()
			while wait() do
				pcall(function()
					if _G.Teleport then
						if (v174.Name == TISLANDSele) then
							v50(v174.CFrame * CFrame.new(0, 50, 0));
						end
					end
				end);
			end
	...
	local v80 = v40:Dropdown({Default=DefaultDrop,Content=Locations,Flag="Locations Drop",Callback=function(v70)
		TISLANDSele = v70;
	end});
	local v81 = v40:Dropdown({Default="",Content=v79,Flag="NPC Drop",Callback=function(v70)
		TeleportNPC = v70;
		v80:Set("");
	end});
	local v82 = v40:Toggle({Name="Teleport",Flag="Toggle 2",Default=false,Callback=function(v52)
		_G.Teleport = v52;
	end});
	...
	local v83 = v40:Separator(" BoatSpeed multiply ");
	v40:Slider({Text=" multiply : [value] ",Default=1,Min=0,Max=5,Float=0.5,Flag="Slider 1",Callback=function(v78)
		_G.BoatSped = v78;
	end});
	local v84 = v40:Toggle({Name=" BoatSpeed multiply ",Flag="BoatSpeed_multiply",Default=false,Callback=function(v52)
		pcall(function()
			if v52 then
				local function v286()
					...
					while wait() do
						for v385, v386 in pairs(game:GetService("Workspace").Boats:GetChildren()) do
							v386.VehicleSeat.BodyVelocity.Velocity = v386.VehicleSeat.BodyVelocity.Velocity * _G.BoatSped;
						end
					end
				end
				coroutine.wrap(v286)();
	...
	v40:Button({Name="Fix BoatSpeed ( multiply Bug ) ",Callback=function()
			...
			local function v231()
				...
				while wait() do
					for v365, v366 in pairs(game:GetService("Workspace").Boats:GetChildren()) do
						v366.VehicleSeat.BodyVelocity.Velocity = v366.VehicleSeat.BodyVelocity.Velocity * _G.BoatSped;
					end
				end
			end
			coroutine.wrap(v231)();
	...
	local v85 = v40:Separator(" Combat ");
	local v86 = v40:Label(" Silent aim : OFF ");
	local v87 = v40:Label(" LockPlayer : ??? ");
	local v88 = v40:Label(" Hp player : ??? ");
	FovAim = 50;
	...
	_G.PL = "";
	_G.SpeedTP = 100;
	v40:Slider({Text="Fov : [value]",Default=50,Min=10,Max=500,Float=1,Flag="Slider 1",Callback=function(v78)
		FovAim = v78;
	end});
	local v90 = v40:ColorPicker({Name=" ColorAim ",Default=Color3.fromRGB(0, 255, 0),Flag="ColorAim",Callback=function(v89)
		ColorAim = v89;
	end});
	local v93 = v40:Keybind({Name=" Opening Silent aim ",Default=Enum.KeyCode.L,Blacklist={Enum.UserInputType.MouseButton1,Enum.UserInputType.MouseButton2},Flag="Keybind 1",Callback=function(v91, v92)
		_G.Opening_Silent = v91;
		if v92 then
			print("Keybind 1 is now " .. tostring(v91));
		else
			print("Keybind 1 was pressed");
		end
	end});
	local v93 = v40:Keybind({Name=" Reset Silent aim ",Default=Enum.KeyCode.P,Blacklist={Enum.UserInputType.MouseButton1,Enum.UserInputType.MouseButton2},Flag="Keybind 1",Callback=function(v91, v92)
		_G.Reset_Silent = v91;
	end});
	local v84 = v40:Toggle({Name=" ShowFov ",Flag="ShowFov",Default=true,Callback=function(v52)
		ShowFov = v52;
	end});
	v40:Button({Name="Aimbot",Callback=function()
		local v177 = Drawing.new("Circle");
		updateCircle = function(v178, v179)
							...
							if v328.Character:FindFirstChild("HumanoidRootPart") then
								...
								if (v405 < (((getgenv().setting['Fov'] * 6) - 8) / 2)) then
									if (v405 < math.huge) then
										if ((v328.Character.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 1000) then
	...
	local v94 = v40:Separator(" Graphic ");
	local v65 = v40:Toggle({Name="Lock Fps",Flag="Lock_Fps",Default=false,Callback=function(v52)
		if v52 then
			setfpscap(60);
		else
			setfpscap(120);
	...
	local v65 = v40:Toggle({Name="Boost FPS Windows",Flag="Boost_FPS_Windows",Default=false,Callback=function(v52)
		if v52 then
	...
	local v65 = v40:Toggle({Name="White Screen",Flag="White_Screen",Default=false,Callback=function(v52)
		if v52 then
			v3:Set3dRenderingEnabled(false);
			setfpscap(30);
		else
	...
	v40:Button({Name="Fast Mode",Callback=function()
		local function v182()
	...
	local v84 = v35:Toggle({Name=" Ctrl Tp ",Flag="Ctrl_Tp",Default=true,Callback=function(v52)
		getgenv().Enabled = v52;
		local v184 = true;
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
	...
	v37:Button({Name="Join With Jobid ( Gui TextBox lib Bug ) ",Callback=function()
	...
	v37:Button{
		...
		Callback  = function()
			v50(game:GetService("Workspace").Characters[tostring(_G.SlectPlayer)].HumanoidRootPart.CFrame)
		end
	}
	...
	v37:Button{
		...
		Callback  = function()
			...
			if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(WeaponName) then
				getgenv().Tol = game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(WeaponName);
				game.Players.LocalPlayer.Character.Humanoid:EquipTool(Tol);
			end
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Characters[tostring(_G.SlectPlayer)].HumanoidRootPart.CFrame
			local args = {[1] = "X"}
	...
	task.spawn(function()
		if _G.Auto_Random_Fruit then
			while _G.Auto_Random_Fruit do
				task.wait(2);
				local v310 = {[1]="Cousin",[2]="Buy"};
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(v310));
			end
		else
			_G.Auto_Random_Fruit = false;
		end
	...
	pcall(function()
		coroutine.wrap(function()
			getgenv().Config = {["FastAttack"] = _G.FastAttack}
			local v222 = require(game.ReplicatedStorage.Util.CameraShaker);
			v222:Stop();
			for v256, v256 in pairs(getreg()) do
				if ((typeof(v256) == "function") and (getfenv(v256).script == game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework)) then
					for v379, v379 in pairs(debug.getupvalues(v379)) do
						if (typeof(v379) == "table") then
							spawn(function()
								game:GetService("RunService").RenderStepped:Connect(function()
									if getgenv().Config['FastAttack'] then
										pcall(function()
											v379.activeController.timeToNextAttack = -(math.huge ^ (math.huge ^ math.huge));
											v379.activeController.attacking = false;
											v379.activeController.increment = 4;
											v379.activeController.blocking = false;
											v379.activeController.hitboxMagnitude = 100;
											v379.activeController.humanoid.AutoRotate = true;
											v379.activeController.focusStart = 0;
											v379.activeController.currentAttackTrack = 0;
											sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRaxNerous", math.huge);
										end);
									end
								end);
	...
	task.spawn(function()
		pcall(function()
			while wait() do
				...
				if _G.lockP then
					v25:Set("Manake Hub Premium script | " .. v257 .. "fps | Aimlock | ON   NamePlayer |  " .. tostring(LockName) .. "  Health  |  " .. tostring(HPPlayer));
				else
	...
	require(game:GetService("ReplicatedStorage").Notification).new("Manake Hub"):Display();
end);
end);
